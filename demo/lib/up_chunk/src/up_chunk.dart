...
class UpChunk {
  ...
  _validateOptions() {
    ...
    if (endPoint == null && endPointResolver == null) {
      throw Exception('either endPoint or endPointResolver must be defined');
    }
    ...
    if (delayBeforeAttempt < 0) {
      throw Exception('delayBeforeAttempt must be a positive number');
    }
  }
